...
export default class RectTerrainMap extends RectTileLoader {
    ...
    renderTerrain(x, y, terrainId, direction) {
        ...
        const tile = new RectTerrainMapTile(x * this.tileSize, y * this.tileSize, spritesheetInfo.src, spritesheetInfo.atlas, frame.frame, this._options.tileFadeDuration);
        ...
        this.mapObjects.forEach((mapObject) => {
            ...
            if (objectX === x && objectY === y) {
                ...
                if (objectInfo) {
                    ...
                    const tile = new RectTerrainMapTile(mapObject.x, mapObject.y, spritesheetInfo.src, spritesheetInfo.atlas, objectInfo.frame, this._options.tileFadeDuration);
