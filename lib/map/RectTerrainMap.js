...
export default class RectTerrainMap extends RectTileLoader {
    ...
    constructor(tileSize, spritesheets, terrains, objects, terrainMap, mapObjects, _options = {}) {
        super(tileSize, {
    ...
    renderTerrain(x, y, terrainId, direction) {
        ...
        const tile = frame.animation
            ? new AnimatedRectTerrainMapTile(x * this.tileSize, y * this.tileSize, spritesheetInfo.src, spritesheetInfo.atlas, frame.animation, frame.fps, this._options.tileFadeDuration)
            : new RectTerrainMapTile(x * this.tileSize, y * this.tileSize, spritesheetInfo.src, spritesheetInfo.atlas, frame.frame, this._options.tileFadeDuration);
            ...
            if (objectX === x && objectY === y) {
                ...
                if (objectInfo) {
                    ...
                    const tile = objectInfo.animation
                        ? new AnimatedRectTerrainMapTile(mapObject.x, mapObject.y, spritesheetInfo.src, spritesheetInfo.atlas, objectInfo.animation, objectInfo.fps, this._options.tileFadeDuration)
                        : new RectTerrainMapTile(mapObject.x, mapObject.y, spritesheetInfo.src, spritesheetInfo.atlas, objectInfo.frame, this._options.tileFadeDuration);
