            ...
            if (objectX === x && objectY === y) {
                ...
                if (objectInfo) {
                    ...
                    if (objectInfo.frames.length > 1) {
                        object = new AnimatedRectMapObject(mapObject.x, mapObject.y, spritesheetSrc, this.altases[objectInfo.spritesheet], `object_${mapObject.object}`, objectInfo.fps, this._options.tileFadeDuration);
                    }
                    else {
