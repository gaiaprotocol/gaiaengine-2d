...
class CollisionUtil {
  ...
  private checkRectAndRect(
    ...
    if (
      this.checkPointInRect(a1x, a1y, bx, by, bw, bh, bsin, bcos) ||
    ...
    if (
      this.checkPointInRect(b1x, b1y, ax, ay, aw, ah, asin, acos) ||
  ...
  public check(ac: Collider, at: Transform, bc: Collider, bt: Transform) {
